...
//        System.out.println(Cr.insert("PB","Papua Newguine","3"));
       //   System.out.println(Cr.update("PB","Papua N","4"));
//        for (CountryController cuntry : Cr.getById("AR")){
//            System.out.println(cuntry.getCountryId() + " - " + cuntry.getCountryName()
//                    + " - " + cuntry.getRegionId());
//        }
